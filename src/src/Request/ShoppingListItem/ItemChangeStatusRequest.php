...
class ItemChangeStatusRequest extends AbstractRequestValidator implements RequestValidatorInterface
{
    ...
    public function validate(array $data): array
    {
        $constraints = new Assert\Collection([
            ...
            'status' => [
                new Assert\NotBlank(message: 'El Status es obligatorio.'),
